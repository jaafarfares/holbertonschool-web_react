import { normalizedNotifications, normalizedUsers, normalizedMessages } from '../schema/notifications';
...
test('Normalized data contains correct result array', () => {
  ...
  const resultArray = Object.keys(normalizedNotifications);
...
test('Normalized data contains correct users entity', () => {
  ...
  const user = normalizedUsers['5debd764a7c57c7839d722e9'];
...
test('Normalized data contains correct messages entity', () => {
  ...
  const message = normalizedMessages['efb6c485-00f7-4fdf-97cc-5e12d14d6c41'];
...
test('Normalized data contains correct notifications entity', () => {
  ...
  const notification = normalizedNotifications['5debd7642e815cd350407777'];
